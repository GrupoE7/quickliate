...
import com.example.quickliate.databinding.ActivityP2Binding;
...
private ActivityP2Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     setContentView(binding.getRoot());
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_p2);
